...
/*
  Name:    my_open
  Details: Opens a file for read or write, returns file descripor
*/
int my_open(char* filename, int flags){
    int odev = dev;
    int ino, mode;
...
/*
  Name:    my_close
  Details: Closes a file descriptor and deallocates the inode and open file table
*/
int my_close(int fd){
  OFT* table;
...
/*
 Name:    my_lseek
 Details: For a given fd, change the offset to the position vlue
*/
...
/*
  Name:    pfd
  Details: Prints all the assigned file descriptors for the running proc
*/
int pfd(void){
